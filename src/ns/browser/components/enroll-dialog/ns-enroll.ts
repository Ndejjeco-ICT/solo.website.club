...
<div class="enroll-dialog-main-wrapper">
    <div class="enroll-sections-wrapper">
        <div class="control-component">
            <div class="close-manager">&times;</div>
        </div>
        ...
        <div class="section-wrapper-2">
            <div class="main-wrapper">
                <div class="cl-title">Sorry!</div>
                <div class="cl-title-2">Service is Still in Development...</div>
            </div>
        </div>
    </div>
</div>
...
export class EnrollDialog extends HTMLElement implements IWebComponents {
    ...
    private _closeComponentControl: HTMLDivElement | null = null;
    constructor() {
        super();
    }
    static is() {
    ...
    private _attachComponents() {
        this._closeComponentControl = this.querySelector(".control-component");
    }
    connectedCallback() {
        this.appendChild(Template_.content.cloneNode(true));
        this._attachComponents();
        this._enrollCloseDialogEventListener();
    }
    private _enrollCloseDialogEventListener() {
        if (this._closeComponentControl) {
            addDisposableEventListener(this._closeComponentControl, "click", () => {
                dialogHostEventManager.emit("close-dialog", "enroll");
            })
