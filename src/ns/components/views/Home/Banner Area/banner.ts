...
export class BannerAreaComponent extends HTMLElement implements IWebComponents {
    ...
    private _bannerContainerSection:HTMLDivElement|null = null;
    ...
    private async _preloadBannerImageSource() {
        if(this._bannerContainerSection) {
            this._bannerContainerSection.style.backgroundImage = "url()"
        }
    }
    ...
    __createComponentAttachment() {
        ...
        this._bannerContainerSection = this.querySelector(".ponaco-splitview-1")
    };
    /**
