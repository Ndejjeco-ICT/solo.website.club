...
export class CoreValuesSectionComponent extends HTMLElement implements IWebComponents {
    ...
    private async _preloadSourceImage(){
        if(this._coreValuecrComponent){
            this._coreValuecrComponent.style.backgroundImage = `linear-gradient(to bottom, rgba(0, 0, 0, 0.342), rgba(0, 0, 0, 0.73)), url('../../../Imgs/new/cr_corevalues.jpg')`
        }
    }
